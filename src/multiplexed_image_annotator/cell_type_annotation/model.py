...
class Annotator(object):
    ...
    """
    def __init__(self, marker_list_path, image_path, device, main_dir = './', batch_id='', strict=True, normalization=True, blur=False, amax=1, confidence=0.25, cell_size = 30, cell_type_confidence=None):
        self.device = device
        ...
        self.preprocessor = ImageProcessor(image_path, self.channel_parser, main_dir, device, batch_id, normalization, blur, amax, cell_size)
        self._loaded = False
